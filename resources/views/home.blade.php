...
<p>Импортировать xls-файл, нажав на эту кнопку:<a href={{ route('import') }}><button type="button" class="btn btn-sm btn-danger m-2" style="display: inline">импорт Xls</button></a></p>
